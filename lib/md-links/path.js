...
exports.readFile = exports.checkIsMd = exports.fileReturn = exports.checkIsFile = exports.transformRelativePath = exports.checkIfRouteIsAbosulte = void 0;
...
const checkIfRouteIsAbosulte = route => path.isAbsolute(route); // console.log(checkIfRouteIsAbosulte('/home/lyas/Documentos/Laboratoria/Bootcamp/md-links/LIM011-fe-md-links/README.md'));
// convierte una ruta relativa en abosoluta


exports.checkIfRouteIsAbosulte = checkIfRouteIsAbosulte;

const transformRelativePath = route => path.resolve(route); // console.log(transformRelativePath('README.md'));
...
const checkIsMd = route => fileReturn(route).filter(element => path.extname(element) === '.md'); // esto para considerar en la programación


exports.checkIsMd = checkIsMd;

const readFile = route => fs.readFileSync(route, 'utf8'); // console.log(readFile('/home/lyas/Documentos/Laboratoria/Bootcamp/md-links/LIM011-fe-md-links/test/prueba/paraTest/prueba.md'));
// buscar links


exports.readFile = readFile;
const re = /\[(.+)\]\((.+)\)/; //  const str = '<html>\n    <head></head>\n    <body>\n        <h1>Example</h1>\n        <p>Look a this great link : <a href="https://stackoverflow.com">Stackoverflow</a> http://anotherlinkoutsideatag</p>\n\n        Copyright <a href="https://stackoverflow.com">Stackoverflow</a>\n    </body>\';\n';
