...
const fileReturn = route => {
  ...
  if (checkIsFile(route)) {
    ...
    files.forEach(element => {
      ...
      arrayFilePath = arrayFilePath.concat(fileReturn(newRoute)); // console.log(arrayOfPathFile);
    });
  }
...
const readFile = route => fs.readFileSync(route, 'utf8'); // guarda los link del archivo .md en un array de objetos
